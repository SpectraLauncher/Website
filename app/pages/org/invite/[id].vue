...
<template>
  <UiPageShell width="max-w-lg">
    <UiPanel class="flex flex-col items-center p-8 text-center sm:p-10">
      <span class="grid size-16 place-items-center rounded-2xl border border-raised-line bg-raised">
