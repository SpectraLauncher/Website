...
// Pure arithmetic, shared so the creator's pricing form works the fee out the
// same way the checkout will. Nothing here touches the database; what the rate
// actually is for a given project lives in server/utils/commission.ts.
